...
description: Build and sharpen a project's domain model. Use when pinning down domain terminology or a ubiquitous language, writing or editing a CONTEXT.md, recording an architectural decision as an ADR, or when another skill needs the domain model maintained.
---
